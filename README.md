...
I run this whole thing as one Vercel account — 100+ projects, 65 domains, my problem when any of it breaks. And when I noticed there was no way for one of my repos to tell an AI agent what a sibling repo already solved, I wrote [a protocol for that](https://github.com/adamtpang/repo-protocol).
